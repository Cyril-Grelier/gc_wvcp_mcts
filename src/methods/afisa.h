...
/**
 * @brief afisa main algorithm with edits on the management of the tabu list
 *
 * From :
 ...
 */
void afisa(Solution &solution, const bool verbose = false);

/**
 * @brief Tabu search from afisa
 *
